(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-requests-admin-requests-module~admin-users-users-module~expert-request-request-m~e0e39388"],{
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getHighlightedExperts = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set("Content-type", "application/json");
     ...
     */
    ApiService.prototype.getRequestByStatus = function (status, uid) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set("Content-type", "application/json");
    ...
    ApiService.prototype.assignCategoryToRequest = function (requestId, category) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set("Content-type", "application/json");
     ...
     * @param status request status
     */
    ApiService.prototype.updateRequestStatus = function (id, status, trackReqId) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set("Content-type", "application/json");
        return this.http.post(this.apiUrl + "/post/updateStatus", { id: id, status: status, trackReqId: trackReqId }, { headers: headers });
    };
    ApiService.prototype.provideInput = function (data) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set("Content-type", "application/json");
...
//# sourceMappingURL=default~admin-admin-requests-admin-requests-module~admin-users-users-module~expert-request-request-m~e0e39388.js.map